...
def save_logs_to_csv(spreadsheets: Dict[str, List[Dict[str, Any]]], directory: str) -> None:
    """
    ...
    users_filename = f"{directory}/users.csv"
    with open(users_filename, "w", newline="") as csvfile:
    ...
    products_filename = f"{directory}/products.csv"
    with open(products_filename, "w", newline="") as csvfile:
        writer = csv.writer(csvfile)
    ...
    inventory_filename = f"{directory}/inventory.csv"
    ...
    orders_filename = f"{directory}/orders.csv"
...
if __name__ == "__main__":
    ...
    save_logs_to_csv(contaverde_data, "contaverde")